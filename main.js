...
//Displaying Recent Search
  (function previousSearch() {
    ...
    zomatoRestaurantCall(previousZomLat, previousZomLon, previousFood)
  ...
  // ----------------------------zomato------------------------------
  function zomatoRestaurantCall(latitiude, longitude, searchFood) {
    ...
    $.ajax({
      ...
      if (responseValue < 5) {
        UIkit.notification({
          message: `<p style="color: #1e87f0;"><strong>Sorry these are the only results. Here are resturants near you</strong></p>`,
        });
